...
def seq_model_gru(**kwargs):
    def thurn():
        return GRUMultiLayer( d_model=kwargs['d_model'], n_layers=kwargs['n_layers'], reset_on_terminate=kwargs['reset_hidden_on_terminate'] )
...
def seq_model_gtrxl(**kwargs):
    def thurn():
        return GTrXL(
                head_dim=kwargs['head_dim'], embedding_dim=kwargs['embedding_dim'], head_num=kwargs['head_num'],
